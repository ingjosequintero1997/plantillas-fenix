...
FIELD_SET_ALIASES = {
	...
	"DISCAPACIDAD": {
		"DISCAPACIDAD FISICA": {"DISCAPACIDAD FISICA", "DISCAPACIDAD FISICA O PSIQUICA", "FISICA", "FISICO"},
		"DISCAPACIDAD PSIQUICA": {"DISCAPACIDAD PSIQUICA", "PSIQUICA", "PSIQUICO"},
		"DISCAPACIDAD MENTAL": {"DISCAPACIDAD MENTAL", "DISCAPACIDAD MENTAL O PSIQUICA", "MENTAL"},
		"NINGUNA": {"NINGUNA", "NINGUNO", "NINGUNO DE LAS ANTERIORES", "NO TIENE", "SIN DISCAPACIDAD", "NO", "N", "NONE"},
		"SIN DATO": {"SIN DATO", "NO DEFINIDO", "SIN INFORMACION", "NO REPORTA", "NO APLICA", "NO APLICA"},
	},
	"CONTROL TRADICIONAL": {
		"SI": {"SI"},
		"NO": {"NO"},
	...
	"REGIMEN DE AFILIACION": {
		"SUBSIDIADO": {"SUBSIDIADO", "SUBSIDIADA", "S"},
		"CONTRIBUTIVO": {"CONTRIBUTIVO", "COTIZANTE", "C"},
	},
	"GENERO": {
		"MASCULINO": {"M", "MASCULINO", "HOMBRE"},
		"FEMENINO": {"F", "FEMENINO", "MUJER"},
	...
	"NIVEL EDUCATIVO": {
		...
		"SECUNDARIA COMPLETA": {"SECUNDARIA", "SECUNDARIA COMPLETA", "BACHILLER", "BACHILLERATO", "BACHILLER COMPLETO", "BACHILLERATO COMPLETO", "11", "GRADO 11", "SECNDARIA", "SECUNDARIA COMPLETA", "SECUNDARIA COMPLETA ", "BASICA SECUNDARIA", "BASICA SECUNDARIA COMPLETA", "SECUNDARIA COMPLETO", "5 DE PRIMERA", "NORMALISTA"},
		...
		"TECNICO": {"TECNICO", "TECNICA", "TECNICO LABORAL", "TECNICO PROFESIONAL", "MEDIA TECNICA", "TECNICA PROFECIONAL", "MEDIA TECNICA (BACHILLERATO TECNICO)"},
		"TECNOLOGO": {"TECNOLOGO", "TECNOLOGA", "TECNOLOGIA"},
		"PROFESIONAL UNIVERSITARIO": {"PROFESIONAL", "UNIVERSITARIO", "PROFESIONAL UNIVERSITARIO", "UNIVERSIDAD", "UNIVERSITARIA", "PROFESIONAL UNIVERSITARIA", "ESPECIALIZACION"},
		"SIN DATO": {"NO DEFINIDO", "NO DEFINED", "NO DEFINIDO (NINGUNO)", "NO DEFINIDO (NINGUNA)", "OTRO", "SIN INFORMACION", "NO REPORTA", "NINGUNO", "NINGUNA", "NO DEFINIEDO", "MEDICA ACADEMICA O CLASICA"},
	},
	"ESTADO CIVIL": {
		"SOLTERA": {"SOLTERA", "SOLTERO", "SOLTERA"},
		"CASADA": {"CASADA", "CASADO", "CAS", "CASADA POR TRADICION", "CASADO POR TRADICION"},
		"DIVORCIADA": {"DIVORCIADA", "DIVORCIADO", "DIVOR"},
		"VIUDA": {"VIUDA", "VIUDO"},
		"UNION LIBRE": {"UNION LIBRE", "UNIÓN LIBRE", "UNIDO", "UNIDA", "UNION", "CONCUBINATO"},
	},
	"PERIODO INTERGENESICO": {
		"NINGUNO": {"NINGUNO", "NINGUNA", "NO"},
		"<12 MESES": {"<12 MESES", "< DE 12 MESES", "MENOS DE 12 MESES", "MENOR A 12 MESES"},
		"12 A 24 MESES": {"12 A 24 MESES", "12 A 24"},
		"25 A 48 MESES": {"25 A 48 MESES", "25 A 48", "26 A 48 MESES", "26 A 48"},
		"49 Y MAS": {"49 Y MAS", "49 O MAS", "MAS DE 49", "49 O MAS MESES", "MAS DE 49 MESES"},
	},
	...
	"RESULTADO REALIZACION HEMOCLASIFICACION (FACTOR RH)": {
		"NA": {"NA", "N/A", "SIN DATO", "NO APLICA"},
		"O+": {"O+", "0+", "O POSITIVO", "O POS", "O +", "0 +"},
		"O-": {"O-", "0-", "O NEGATIVO", "O NEG", "O -", "0 -"},
		"A+": {"A+", "A POSITIVO", "A POS", "A +"},
		"A-": {"A-", "A NEGATIVO", "A NEG", "A -"},
		"AB+": {"AB+", "AB POSITIVO", "AB POS", "AB +"},
		"AB-": {"AB-", "AB NEGATIVO", "AB NEG", "AB -"},
		"B+": {"B+", "B POSITIVO", "B POS", "B +"},
		"B-": {"B-", "B NEGATIVO", "B NEG", "B -"},
	},
	...
	"TIPO DE TRATAMIENTO SUMINISTRADO PARA ANEMIA": {
		"NA": {"NA", "N/A", "NO APLICA", "SIN DATO"},
		"1. HIERRO ORAL": {"HIERRO ORAL", "HIERRO", "ORAL", "1. HIERRO ORAL", "1 HIERRO ORAL", "1"},
		"2. HIERRO PARENTERAL": {"HIERRO PARENTERAL", "PARENTERAL", "2. HIERRO PARENTERAL", "2 HIERRO PARENTERAL", "2"},
		"3. TRANSFUSION SANGUINEA": {"TRANSFUSION SANGUINEA", "TRANSFUSION", "SANGUINEA", "3. TRANSFUSION SANGUINEA", "3 TRANSFUSION SANGUINEA", "3"},
	},
	"TIPO": {
		"DIU": {"DIU"},
		"INYECCION MENSUAL": {"INYECCION MENSUAL", "INY MENSUAL", "IM"},
		"INYECCION TRIMESTRAL": {"INYECCION TRIMESTRAL", "INY TRIMESTRAL", "IT"},
		"PILDORAS": {"PILDORAS", "PILDORA", "PASTILLAS", "ANTICONCEPTIVOS ORALES", "ACO"},
		"CONDON": {"CONDON", "CONDONES", "PRESERVATIVO", "PRESERVATIVOS"},
		"POMEROY": {"POMEROY"},
		"NINGUNO": {"NINGUNO", "NINGUNA", "NO", "N", "NONE"},
		"NA": {"NA", "N/A", "SIN DATO"},
		"SIN DATO": {"NO DEFINIDO", "NO DEFINED", "SIN INFORMACION"},
	},
	"CONDICION DEL SUMINISTRO DEL ASA": {
		"1. ASA INDICADO Y SUMINISTRADO": {"ASA INDICADO Y SUMINISTRADO", "1", "INDICADO Y SUMINISTRADO"},
		"2. ASA INDICADO Y NO SUMINISTRADO": {"ASA INDICADO Y NO SUMINISTRADO", "2", "INDICADO Y NO SUMINISTRADO"},
		"3. ASA NO INDICADA NI SUMINISTRADA": {"ASA NO INDICADA NI SUMINISTRADA", "3", "NO INDICADA NI SUMINISTRADA"},
		"4. ASA SUMINISTRADO SIN SER INDICADO": {"ASA SUMINISTRADO SIN SER INDICADO", "4", "SUMINISTRADO SIN SER INDICADO"},
		"5. NO REQUIERE ASA": {"NO REQUIERE ASA", "5", "NO REQUIERE"},
	},
	"RELA ENTRE ANEMIA VS TRATAMIENTO": {
		"1. TRATAMIENTO PARA ANEMIA INDICADO Y SUMINISTRADO": {"INDICADO Y SUMINISTRADO", "TRATAMIENTO INDICADO Y SUMINISTRADO", "1", "TRATAMIENTO PARA ANEMIA INDICADO Y SUMINISTRADO"},
		"2. TRATAMIENTO PARA ANEMIA INDICADO Y NO SUMINISTRADO": {"INDICADO Y NO SUMINISTRADO", "TRATAMIENTO INDICADO Y NO SUMINISTRADO", "2", "TRATAMIENTO PARA ANEMIA INDICADO Y NO SUMINISTRADO"},
		"3. TRATAMIENTO PARA ANEMIA NO INDICADA NI SUMINISTRADA": {"NO INDICADA NI SUMINISTRADA", "TRATAMIENTO NO INDICADO NI SUMINISTRADO", "3", "TRATAMIENTO PARA ANEMIA NO INDICADA NI SUMINISTRADA"},
		"4. NO REQUIERE TRATAMIENTO HEMOGLOBINA ADECUADA": {"NO REQUIERE", "HEMOGLOBINA ADECUADA", "4", "NO REQUIERE TRATAMIENTO HEMOGLOBINA ADECUADA", "NO REQUIERE TRATAMIENTO"},
	},
}
