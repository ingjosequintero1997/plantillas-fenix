...
FIELD_SET_ALIASES = {
	...
	"RELA ENTRE ANEMIA VS TRATAMIENTO": {
		"1. TRATAMIENTO PARA ANEMIA INDICADO Y SUMINISTRADO": {"INDICADO Y SUMINISTRADO", "TRATAMIENTO INDICADO Y SUMINISTRADO", "1"},
		"2. TRATAMIENTO PARA ANEMIA INDICADO Y NO SUMINISTRADO": {"INDICADO Y NO SUMINISTRADO", "TRATAMIENTO INDICADO Y NO SUMINISTRADO", "2"},
		"3. TRATAMIENTO PARA ANEMIA NO INDICADA NI SUMINISTRADA": {"NO INDICADA NI SUMINISTRADA", "TRATAMIENTO NO INDICADO NI SUMINISTRADO", "3"},
		"4. NO REQUIERE TRATAMIENTO HEMOGLOBINA ADECUADA": {"NO REQUIERE", "HEMOGLOBINA ADECUADA", "4"},
	},
}
