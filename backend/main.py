...
async def debug_oci():
	...
	info["key_starts_with"] = repr(key_raw[:40]) if key_raw else ""
	info["key_ends_with"] = repr(key_raw[-40:]) if key_raw else ""
	info["key_has_newlines"] = "\n" in key_raw
	info["key_backslash_n"] = "\\n" in key_raw
...
DEPARTAMENTOS = {
    ...
    "91": "AMAZONAS", "94": "GUAINIA", "95": "VAUPES", "97": "VICHADA",
}
...
MUNICIPIOS = {
    ...
    "20001": "VALLEDUPAR", "20011": "AGUACHICA", "20013": "ASTREA",
    "20032": "BECERRIL", "20045": "CALIFORNIA", "20060": "EL CARMEN DE BOLIVAR",
    "20099": "GAMARRA", "20110": "GONZALEZ", "20124": "LA GLORIA",
    "20130": "JURADO", "20170": "MANAURE", "20174": "PALESTINA",
    "20175": "PELAYA", "20183": "PUEBLO BELLO", "20196": "RIO DE ORO",
    "20207": "LA PAZ", "20215": "SAN ALBERTO", "20220": "SAN DIEGO",
    "20226": "SAN MARTIN", "20238": "TAMALAMEQUE",
    "23001": "MONTERIA", "23068": "AYAPEL", "23079": "BUENAVISTA",
    "23090": "CANALETE", "23100": "CERETE", "23162": "CHIMA",
    "23168": "CHINU", "23182": "CIENAGA DE ORO", "23189": "COTORRA",
    "23295": "LA APARTADA", "23300": "LORICA", "23350": "MOMIL",
    "23355": "MONTELIBANO", "23370": "MOÑITOS", "23400": "PLANETA RICA",
    "23417": "PUERTO ESCONDIDO", "23430": "PUERTO LIBERTADOR",
    "23440": "PURISIMA DE LA CONCEPCION", "23460": "SAHAGUN",
    "23480": "SAN ANDRES DE SOTAVENTO", "23491": "SAN ANTERO",
    "23495": "SAN BERNARDO DEL VIENTO", "23497": "SAN CARLOS",
    "23540": "SAN PELAYO", "23550": "TIERRALTA", "23570": "VALENCIA",
    ...
    "44090": "DIBULLA", "44098": "DISTRACCION", "44110": "EL MOLINO",
	...
	try:
		...
		if not ips_nombre:
			try:
				...
				pass
		# 3) Buscar en usuarios_ips por uid
		if not ips_nombre:
			try:
				_uid = getattr(current_user, "id", None)
				if _uid:
					_ips_row = db.query(UsuarioIPS).filter(UsuarioIPS.id == int(_uid)).first()
					if _ips_row:
