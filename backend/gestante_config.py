...
ALLOWED_BY_NAME = {
    ...
    "Apoyo familiar": ["NA", "Si", "No"],
    "Embarazo deseado": ["NA", "Si", "No"],
    "Hábitos de riesgo": ["NA", "Fuma", "Toma Alcohol", "Consumo de Drogas"],
    ...
    "Resultado Primera Prueba Treponemica Rápida Sífilis": ["NA", "POSITIVO", "NEGATIVO"],
    "Resultado Segunda Prueba Treponemica Rápida Sífilis": ["NA", "POSITIVO", "NEGATIVO"],
    "Resultado Tercera Prueba Treponemica Rápida Sífilis": ["NA", "POSITIVO", "NEGATIVO"],
