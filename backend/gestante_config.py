...
RAW_FIELDS: list[tuple[str, str]] = [
    ...
    ("Quien Realizó la Consulta", "TEXT"),
    ("Tipo", "SET"),
    ("Fecha", "DATE"),
...
ALLOWED_BY_NAME = {
    ...
    "Resultado Primer Tamizaje prueba de VIH": ["POSITIVO", "NEGATIVO"],
    "Resultado Segundo Tamizaje Prueba de VIH": ["POSITIVO", "NEGATIVO"],
    "Resultado Tercer Tamizaje Prueba de VIH": ["POSITIVO", "NEGATIVO"],
    "Resultado Primera Prueba Treponemica Rápida Sífilis": ["POSITIVO", "NEGATIVO"],
    "Resultado Segunda Prueba Treponemica Rápida Sífilis": ["POSITIVO", "NEGATIVO"],
    "Resultado Tercera Prueba Treponemica Rápida Sífilis": ["POSITIVO", "NEGATIVO"],
    "Resultado Toma Segunda Prueba VIH": ["POSITIVO", "NEGATIVO"],
    "Resultado Urocultivo": ["POSITIVO", "NEGATIVO"],
    "Resultado Realizacion Hemoclasificación (Factor RH)": ["O+", "O-", "A+", "A-", "AB+", "AB-", "B+", "B-"],
    "Resultado Antigeno Superficie Hepatitis B": ["NEGATIVO", "POSITIVO"],
    "Resultado Toxoplasma": ["NEGATIVO", "POSITIVO"],
    "Resultado Tamizaje de cuello uterino": ["POSITIVO", "NEGATIVO"],
    "Resultado Rubeola": ["NEGATIVO", "POSITIVO"],
    "Resultado Prueba de Tamizaje para Estreptococo Grupo B": ["NEGATIVO", "POSITIVO"],
    "Resultado Gota gruesa (Malaria)": ["NEGATIVO", "POSITIVO"],
    "Resultado Chagas": ["NEGATIVO", "POSITIVO"],
