    ...
    <div className="space-y-6 fade-in">
      ...
      {resultado && resultado.encontrado === false && (
        <div className="panel flex items-center gap-3">
          ...
          <div>
            <div className="font-semibold" style={{ color: 'var(--text-primary)' }}>No se encontró la usuaria</div>
            <div className="text-sm mt-0.5" style={{ color: 'var(--text-secondary)' }}>No hay un afiliado registrado con el documento {resultado.documento}.</div>
          </div>
        </div>
      )}
