...
export default function IndicadoresView({ templateKey = 'gestante', dataValidada = '', templateNames = [], ipsName = '' }) {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      if (id) { try { result = await fetchIndicadoresDeCargue(id, ipsName) } catch (e) { result = null } }
  ...
  const handleExport = useCallback(async () => {
    ...
    try {
      ...
      await descargarIndicadoresExcel(id, `indicadores_pare_mm_${fecha}.xlsx`, ipsName)
